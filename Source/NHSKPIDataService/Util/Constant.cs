...
namespace NHSKPIDataService.Util
{
    public class Constant
    {
        ...
        public static readonly string MSG_KpiGroup_Success_Update           = "KPI group details successfully updated ";
         ...
         public static readonly string MSG_Hospital_Name_Exist = "This hospital has alreasy registerd with NHSKPI.<BR>(1) If you are not the system administrator for HOSPITAL_NAME, please neter your email so we can send you who to contact in order to create you an account.<BR>(2) If you the system administrator and forgotton your credentials please press \"Resend Credentilas\" button to receive the login details again.<BR>(3) If you need to create a new account due any other reason please contact us via email and will be in touch with you within 24 hours of your request.";
        #endregion
