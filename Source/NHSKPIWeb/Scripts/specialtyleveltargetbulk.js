...
function ValidateControls(idlist) {
    ...
    if (wardlist.length > 0) {
        ...
        if (valid) {
            ...
            var response = Views_KPI_SpecialtyLevelTargetBulk.SaveBulkTarget(monthlyDescription, monthlyTargetGreen, monthlyTargetAmber, YTDDescription, YTDTargetGreen, YTDTargetAmber, document.getElementById('ctl00_Contentbody_hdnHospitalId').value, document.getElementById('ctl00_Contentbody_hdnKPIId').value, document.getElementById('ctl00_Contentbody_hdnYear').value, document.getElementById('ctl00_Contentbody_hdnKPIType').value);
