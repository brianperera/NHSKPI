...
function ValidateControls(idlist) {
    ...
    if (wardlist.length > 0) {
        ...
        if (valid) {
            ...
            var response = Views_KPI_WardLevelDataBulkKPI.SaveBulkData(Numarator, Denominator, YTD, document.getElementById('ctl00_Contentbody_hdnHospitalId').value, document.getElementById('ctl00_Contentbody_hdnWardId').value, document.getElementById('ctl00_Contentbody_hdnYear').value);
