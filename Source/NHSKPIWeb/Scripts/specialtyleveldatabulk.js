...
function ValidateControls(idlist) {
    ...
    if (wardlist.length > 0) {
        ...
        if (valid) {
            ...
            //alert(Denominator);
            //alert(YTD);
            var response = Views_KPI_SpecialtyLevelDataBulk.SaveBulkData(Numarator, Denominator, YTD, document.getElementById('ctl00_Contentbody_hdnHospitalId').value, document.getElementById('ctl00_Contentbody_hdnKPIId').value, document.getElementById('ctl00_Contentbody_hdnYear').value, getKPIBulkWardData_callback);
