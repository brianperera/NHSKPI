<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="SpecialtyLevelTargetUpdate.aspx.cs" Inherits="Views_KPI_SpecialtyLevelTargetUpdate"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    <div class="page-header position-relative">
        <h1>
            Specialty Level Target/Data Search
        </h1>
    </div>
    <div class="grid_12">
        <div class="clear">
    ...
    <div class="grid_24">
        ...
        <div class="gridtable">
            <div class="gridwrap">
                ...
                <div class="gridtitle">
                    <h3>
                        Specialty Level Target/Data Search Result</h3>
                </div>
                <div class="gridright">
                </div>
            </div>
        ...
        <asp:GridView CssClass="grid" ID="gvSearchResult" runat="server" AutoGenerateColumns="False"
            OnRowDataBound="gvSearchResult_RowDataBound" DataKeyNames="ManuallyEntered">
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="KPIId,FinancialYear"
                    DataNavigateUrlFormatString="SpecialtyLevelTarget.aspx?KpiId={0}&amp;FinancailYear={1}"
                    HeaderText="Target" Text="Target" />
                <asp:HyperLinkField DataNavigateUrlFields="KPIId,FinancialYear"
                    DataNavigateUrlFormatString="SpecialtyLevelTargetData.aspx?KpiId={0}&amp;FinancailYear={1}"
