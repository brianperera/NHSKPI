<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="SpecialtyLevelTargetData.aspx.cs" Inherits="Views_KPI_SpecialtyLevelTargetData"
        ...
        <ContentTemplate>
            ...
            <div class="grid_24">
                ...
                <div class="grid_6">
                    <asp:DropDownList ID="ddlKPI" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlKPI_SelectedIndexChanged"
                        ValidationGroup="specialtyLevel" CausesValidation="True">
                    </asp:DropDownList>
                ...
                <div class="grid_5">
                    <asp:DropDownList ID="ddlSpecialty" runat="server" OnSelectedIndexChanged="ddlSpecialty_SelectedIndexChanged"
                        AutoPostBack="True" ValidationGroup="specialtyLevel" CausesValidation="True">
                    </asp:DropDownList>
                    <div class="clear">
                    </div>
                        ...
                        <div class="grid_20">
                            <div class="grid_2">
                                <asp:TextBox ID="txtGreenApril" runat="server" MaxLength="10" onkeypress="return isDecimalKey(event);"
                                    ValidationGroup="specialtyLevel"></asp:TextBox>
            ...
            <div class="grid_24" id="divButtons" runat="server">
                ...
                <div class="grid_16">
                    ...
                    <asp:Button ID="btnUpdate" runat="server" Text="Update" Visible="True" ValidationGroup="specialtyLevel"
