<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialtyCSVUpload.aspx.cs" Inherits="Views_KPI_SpecialtyCSVUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    ...
    <div class="grid_24 error_msg info_csv">
        <span class="alert-info">
            <div class="grid_3">
                <asp:Label ID="Label1" runat="server" Text="Specialty Code"></asp:Label>
            </div>
            <div class="grid_20">
                <asp:Label ID="Label2" runat="server" Text="Valid specialty code should be entered. Invalid specialty codes will fail the upload process."></asp:Label>
            </div>
            ...
            <div class="grid_20">
                <asp:HyperLink ID="HyperLink1" NavigateUrl="~/assets/doc/Specialty.csv" runat="server"  Target="_blank">Click here to download</asp:HyperLink>
            </div>
            <div class="clear">
            </div>
        </span>
