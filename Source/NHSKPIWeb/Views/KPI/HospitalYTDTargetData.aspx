<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="HospitalYTDTargetData.aspx.cs" Inherits="Views_KPI_HospitalYTDTargetData"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../../scripts/hospitalleveldata.js" type="text/javascript"></script>
    ...
    <div id="divDynamicTarget" runat="server">
        ...
        <div id="ward">           
                ...
                <div class="grid_24" id="divNumarator" runat="server">
                    ...
                    <div class="grid_1">
                        <asp:TextBox ID="txtGreenApril" runat="server" MaxLength="5" 
                            onkeypress="return isDecimalKey(event);" ValidationGroup="wardLevel"></asp:TextBox>
                ...
                <div class="grid_24"  id="divDenominator" runat="server">
                    ...
                    <div class="grid_1">
                        <asp:TextBox ID="txtAmberApril" runat="server" MaxLength="5" 
                            onkeypress="return isDecimalKey(event);" ValidationGroup="wardLevel"></asp:TextBox>
        ...
        <div class="grid_24" id="divButtons" runat="server">
            ...
            <div class="grid_16">
                ...
                <asp:Button ID="btnUpdate" runat="server" Text="Update" Visible="True" OnClick="btnUpdate_Click"  ValidationGroup="wardLevel" />
            </div>
        </div>
</asp:Content>
