<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialtyYTDTarget.aspx.cs" Inherits="Views_KPI_SpecialtyYTDTarget" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../../scripts/specialtyytdtarget.js" type="text/javascript"></script>
        ...
        <ContentTemplate>
            <div class="grid_24">
                <div class="page-header position-relative">
                    <h1>
                        Specialty Level Year To Date Target
                    </h1>
                </div>
            </div>
            <div class="Hgap15">
            ...
            <div id="divStaticTarget" runat="server">
                ...
                <div id="static">
                    ...
                    <div class="grid_24">
                        ...
                        <div class="grid_5">
                            <asp:TextBox ID="txtYTDTargetDescription" runat="server" Width="40px"></asp:TextBox>
                            <div class="clear">
                            </div>
                        </div>
                        <div class="grid_3">
                    ...
                    <div class="grid_24">
                        ...
                        <div class="grid_1">
                            <asp:TextBox ID="txtYTDTargetGreen" runat="server" MaxLength="5" onkeypress="return isDecimalKey(event);"></asp:TextBox>
                    ...
                    <div class="grid_24">
                        ...
                        <div class="grid_1">
                            <asp:TextBox ID="txtYTDTargetAmber" runat="server" MaxLength="5" onkeypress="return isDecimalKey(event);"></asp:TextBox>
