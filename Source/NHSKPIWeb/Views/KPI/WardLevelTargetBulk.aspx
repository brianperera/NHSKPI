<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="WardLevelTargetBulk.aspx.cs" Inherits="Views_KPI_WardLevelTargetBulk"
    Title="NHS KPI Data Entry Portal" %>

<%@ MasterType VirtualPath="~/Views/Shared/MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <script src="../../scripts/wardleveltargetbulk.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    ...
    <div class="grid_24">
        <div class="page-header position-relative">
            <h1>
                KPI Level Bulk Target Upload By Ward
            </h1>
        </div>
    </div>
    <div class="Hgap15">
