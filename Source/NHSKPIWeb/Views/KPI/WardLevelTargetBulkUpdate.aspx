<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true" CodeFile="WardLevelTargetBulkUpdate.aspx.cs" 
Inherits="Views_KPI_WardLevelTargetBulkUpdate" Title="NHS KPI Data Entry Portal" %>
        ...
        <asp:GridView CssClass="grid" ID="gvSearchResult" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvSearchResult_RowDataBound" DataKeyNames="ManuallyEntered">
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="HospitalId,KPIId,FinancialYear"
                    DataNavigateUrlFormatString="WardLevelTargetBulk.aspx?HospitalId={0}&amp;KpiId={1}&amp;FinancailYear={2}"
                    HeaderText="Target" Text="Target" />
                    <asp:HyperLinkField DataNavigateUrlFields="HospitalId,KPIId,FinancialYear"
                    DataNavigateUrlFormatString="WardLevelDataBulk.aspx?HospitalId={0}&amp;KpiId={1}&amp;FinancailYear={2}"
