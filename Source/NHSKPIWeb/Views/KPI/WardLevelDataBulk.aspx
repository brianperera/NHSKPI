<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="WardLevelDataBulk.aspx.cs" Inherits="Views_KPI_WardLevelDataBulk" %>

<%@ MasterType VirtualPath="~/Views/Shared/MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="../../scripts/wardleveldatabulk.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    ...
    <asp:HiddenField ID="hdnWardIdList" runat="server" />
    ...
    <div class="grid_24">
        <div class="page-header position-relative">
            <h1>
                KPI Level Bulk Data Upload By Ward
            </h1>
        </div>
    </div>
    <div class="Hgap15">
    ...
    <div id="divSucess" class="grid_24 error_msg" style="display: none">
        <asp:Label ID="lblMessage" CssClass="alert-success" runat="server" Text="Ward KPI Data successfully updated"></asp:Label>
    </div>
    <div class="Hgap15">
    </div>
    <div class="grid_24">
