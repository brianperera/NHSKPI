<%@ Page Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="WardLevelTargetUpdate.aspx.cs" Inherits="Views_KPI_WardLevelTargetUpdate"
    ...
    <div class="grid_24">
        ...
        <div class="gridtable">
            <div class="gridwrap">
                ...
                <div class="gridtitle">
                    <h3>
                        Ward Level Target/Data Search Result</h3>
                </div>
                <div class="gridright">
                </div>
            </div>
        ...
        <asp:GridView CssClass="grid" ID="gvSearchResult" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="KPIId,FinancialYear"
                    DataNavigateUrlFormatString="WardLevelTarget.aspx?KpiId={0}&amp;FinancailYear={1}"
                    HeaderText="Target" Text="Target" />
                <asp:HyperLinkField DataNavigateUrlFields="KPIId,FinancialYear"
                    DataNavigateUrlFormatString="WardLevelTargetData.aspx?KpiId={0}&amp;FinancailYear={1}"
