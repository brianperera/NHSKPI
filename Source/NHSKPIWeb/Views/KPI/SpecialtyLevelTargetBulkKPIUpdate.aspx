<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialtyLevelTargetBulkKPIUpdate.aspx.cs" Inherits="Views_KPI_SpecialtyLevelTargetBulkKPIUpdate" %>
    ...
    <div class="grid_24">
        ...
        <asp:GridView CssClass="grid" ID="gvSearchResult" runat="server" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="HospitalId,SpecialtyId,FinancialYear" DataNavigateUrlFormatString="SpecialtyLevelTargetBulkKPI.aspx?HospitalId={0}&amp;SpecialtyId={1}&amp;FinancailYear={2}"
                    HeaderText="Target" Text="Target" />
                <asp:HyperLinkField DataNavigateUrlFields="HospitalId,SpecialtyId,FinancialYear" DataNavigateUrlFormatString="SpecialtyLevelDataBulkKPI.aspx?HospitalId={0}&amp;SpecialtyId={1}&amp;FinancailYear={2}"
