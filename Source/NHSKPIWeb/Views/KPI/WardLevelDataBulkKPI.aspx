<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="WardLevelDataBulkKPI.aspx.cs" Inherits="Views_KPI_WardLevelDataBulkKPI" %>

<%@ MasterType VirtualPath="~/Views/Shared/MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <script src="../../scripts/wardleveldatabulkkpi.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    ...
    <div class="grid_24">
        <div class="page-header position-relative">
            <h1>
                Ward Level Bulk Data Upload By KPI
            </h1>
        </div>
    </div>
    <div class="Hgap15">
