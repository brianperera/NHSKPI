            ...
            {               
                ...
                if (newRow == 0)
                {
                    ...
                    strDashBoardItem.Append("<td class='ward_name' colspan='2'>" +
                       "<a href='../KPI/WardLevelDataBulkKPI.aspx?HospitalId=" + Master.NHSUser.HospitalId + "&WardId=" + rowWard["Id"].ToString() + "&FinancailYear=" + currentFinYear + "' >" + rowWard["WardName"].ToString() + "</a>" +
                    "</td>");
                }
                newRow++;
