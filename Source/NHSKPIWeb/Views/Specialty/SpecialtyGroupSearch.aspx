<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialtyGroupSearch.aspx.cs" Inherits="Views_Specialty_SpecialtyGroupSearch" %>
    ...
    <div class="grid_24">
        ...
        <div class="gridtable">
            <div class="gridwrap">
                ...
                <div class="gridtitle">
                    <h3>
                        Specialty Group(s) Search Result</h3>
                </div>
                <div class="gridright">
                </div>
            </div>
        ...
        <asp:GridView CssClass="grid" ID="gvSearchResult" runat="server" AutoGenerateColumns="False">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="Id" DataTextField="WardGroupName" HeaderText="Name"
                    DataNavigateUrlFormatString="SpecialtyGroupUpdate.aspx?Id={0}" />
