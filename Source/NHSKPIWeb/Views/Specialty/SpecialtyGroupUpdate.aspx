<%@ Page Title="NHS KPI Data Entry Portal" Language="C#" MasterPageFile="~/Views/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="SpecialtyGroupUpdate.aspx.cs" Inherits="Views_Specialty_SpecialtyGroupUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contentbody" runat="Server">
    ...
    <div class="grid_12">
        ...
        <div class="grid_8">
            <asp:Label ID="lblWardGroupName" runat="server" Text="Specialty Group Name :"></asp:Label>
        </div>
        <div class="grid_16">
            <asp:TextBox ID="txtWardGroupName" runat="server" MaxLength="50"></asp:TextBox>
            <div class="clear">
            </div>
            <asp:RequiredFieldValidator ID="rfvWardGroupName" runat="server" ErrorMessage="Specialty Group is required"
